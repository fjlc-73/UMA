...
public class TestRunnerPr41Ej3 {
	//----------------------------------------------------------------------
	//--JUnitTest-----------------------------------------------------------
	//----------------------------------------------------------------------
	...
	public static class JUnitTestSubject {
		...
		private static Student[] crearStudents() {
			...
			try {
				...
				fail("\n> Error: crearStudents: throws unexpected exception");
			}
			return alumnos;
		}
		...
		@Test(timeout = 1000)
		public void asignaturaCalcAverageTest1() throws Exception {
			precondSubject(asg1);
			assertEquals("\n> Error: asg1.getAverage():", 6.20, asg1.getAverage(), 1e-6);
		}
		@Test(timeout = 1000)
		public void asignaturaCalcAverageTest2() {
			precondSubject(asg1);
			try {
				String[] datos = { "xxx" };
				Subject asg2 = new Subject(nmAsg, datos);
				double valor = asg2.getAverage();
				fail("\n> Error: getAverage(): No exception thrown");
			} catch (StudentException e) {
				assertEquals("\n> Error: getAverage(): exception.getMessage():", normalize("No students"), normalize(e.getMessage()));
			} catch (Exception e) {
				fail("\n> Error: getAverage(): the exception thrown is not StudentException");
			}
		}
		@Test(timeout = 1000)
	...
	public static class JUnitTestSubjectWithAverages {
		...
		@Test(timeout = 1000)
		public void asignaturaSetCalcAverageTest1() throws Exception {
			precondSubjectWithAverages(asg1);
			ArithmeticMean cm = new ArithmeticMean();
	...
	//--JUnitTest-----------------------------------------------------------
	//----------------------------------------------------------------------
	public static class JUnitTestDegree {
		@BeforeClass
		public static void beforeClass() {
			// Code executed before the first test method
			System.out.println("Start of Degree JUnit Test");
		}
		@AfterClass
		public static void  afterClass() {
			// Code executed after the last test method
			System.out.println("End of Degree JUnit Test");
		}
		@Before
		public void setUp() throws Exception {
			// Code executed before each test
		...
		@Test(timeout = 1000)
		public void titulacionTest1() {
			assertEquals("\n> Error: Degree", "[COMPUTADORES, INFORMATICA, SOFTWARE, SALUD]", Arrays.toString(Degree.values()));
	...
	//--JUnitTest-----------------------------------------------------------
	//----------------------------------------------------------------------
	public static class JUnitTestStudentWithDegree {
		private StudentWithDegree an1;
		@BeforeClass
		public static void beforeClass() {
			// Code executed before the first test method
			System.out.println("Start of StudentWithDegree JUnit Test");
		}
		@AfterClass
		public static void  afterClass() {
			// Code executed after the last test method
			System.out.println("End of StudentWithDegree JUnit Test");
		}
		@Before
		public void setUp() throws Exception {
			// Code executed before each test
			an1 = new StudentWithDegree("22456784F", "Gonzalez Perez, Juan", Degree.COMPUTADORES, 5.5);
		}
		@After
		public void tearDown() {
			// Code executed after each test
		...
		@Test(timeout = 1000)
		public void alumnoCtorTest1() {
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", Degree.COMPUTADORES, 5.5): DNI:", "22456784F", an1.getDni());
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", Degree.COMPUTADORES, 5.5): Name:", "Gonzalez Perez, Juan", an1.getName());
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", Degree.COMPUTADORES, 5.5): Calificacion:", 5.5, an1.getGrade(), 1e-6);
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", Degree.COMPUTADORES, 5.5): Degree:", Degree.COMPUTADORES, an1.getDegree());
		}
		@Test(timeout = 1000)
		public void alumnoCtorTest2() throws Exception {
			StudentWithDegree an2 = new StudentWithDegree("22456784F", "Gonzalez Perez, Juan", Degree.COMPUTADORES);
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", Degree.COMPUTADORES): DNI:", "22456784F", an2.getDni());
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", Degree.COMPUTADORES): Name:", "Gonzalez Perez, Juan", an2.getName());
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", Degree.COMPUTADORES): Calificacion:", 0.0, an2.getGrade(), 1e-6);
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", Degree.COMPUTADORES): Degree:", Degree.COMPUTADORES, an2.getDegree());
		}
		@Test(timeout = 1000)
		public void alumnoCtorTest3() throws Exception {
			StudentWithDegree an2 = new StudentWithDegree("22456784F", "Gonzalez Perez, Juan", "Computadores", 5.5);
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"Computadores\", 5.5): DNI:", "22456784F", an2.getDni());
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"Computadores\", 5.5): Name:", "Gonzalez Perez, Juan", an2.getName());
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"Computadores\", 5.5): Calificacion:", 5.5, an2.getGrade(), 1e-6);
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"Computadores\", 5.5): Degree:", Degree.COMPUTADORES, an2.getDegree());
		}
		@Test(timeout = 1000)
		public void alumnoCtorTest4() throws Exception {
			StudentWithDegree an2 = new StudentWithDegree("22456784F", "Gonzalez Perez, Juan", "Informatica");
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"Informatica\"): DNI:", "22456784F", an2.getDni());
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"Informatica\"): Name:", "Gonzalez Perez, Juan", an2.getName());
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"Informatica\"): Calificacion:", 0.0, an2.getGrade(), 1e-6);
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"Informatica\"): Degree:", Degree.INFORMATICA, an2.getDegree());
		}
		@Test(timeout = 1000)
		public void alumnoCtorTest5() throws Exception {
			StudentWithDegree an2 = new StudentWithDegree("22456784F", "Gonzalez Perez, Juan", "Software");
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"Software\"): DNI:", "22456784F", an2.getDni());
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"Software\"): Name:", "Gonzalez Perez, Juan", an2.getName());
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"Software\"): Calificacion:", 0.0, an2.getGrade(), 1e-6);
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"Software\"): Degree:", Degree.SOFTWARE, an2.getDegree());
		}
		@Test(timeout = 1000)
		public void alumnoCtorTest6() throws Exception {
			StudentWithDegree an2 = new StudentWithDegree("22456784F", "Gonzalez Perez, Juan", "Salud");
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"Salud\"): DNI:", "22456784F", an2.getDni());
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"Salud\"): Name:", "Gonzalez Perez, Juan", an2.getName());
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"Salud\"): Calificacion:", 0.0, an2.getGrade(), 1e-6);
			assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"Salud\"): Degree:", Degree.SALUD, an2.getDegree());
		}
		@Test(timeout = 1000)
		public void alumnoCtorTestX1() {
			try {
				StudentWithDegree an2 = new StudentWithDegree("22456784F", "Gonzalez Perez, Juan", Degree.COMPUTADORES, -1.0);
				fail("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", Degree.COMPUTADORES, -1.0): No exception thrown");
			} catch (StudentException e) {
				assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", Degree.COMPUTADORES, -1.0): exception.getMessage():", normalize("Negative grade"), normalize(e.getMessage()));
			} catch (Exception e) {
				fail("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", Degree.COMPUTADORES, -1.0): the exception thrown is not StudentException");
			}
		}
		@Test(timeout = 1000)
		public void alumnoCtorTestX2() {
			try {
				StudentWithDegree an2 = new StudentWithDegree("22456784F", "Gonzalez Perez, Juan", "XXX", 5.0);
				fail("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"XXX\", 5.0): No exception thrown");
			} catch (StudentException e) {
				assertEquals("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"XXX\", 5.0): exception.getMessage():", normalize("Wrong degree"), normalize(e.getMessage()));
			} catch (Exception e) {
				fail("\n> Error: new Student(\"22456784F\", \"Gonzalez Perez, Juan\", \"XXX\", 5.0): the exception thrown is not StudentException");
			}
		}
		@Test(timeout = 1000)
		public void alumnoEqualsTest1() throws Exception {
			...
			precond(5.5, an1.getGrade(), 1e-6);
			//------------------------
			Student an2 = new StudentWithDegree("22456784F", "Gonzalez Perez, Juan", Degree.SALUD, 7.7);
			precond("22456784F", an2.getDni());
			precond("Gonzalez Perez, Juan", an2.getName());
			precond(7.7, an2.getGrade(), 1e-6);
			assertTrue("\n> Error: an1.equals(an2): ", an1.equals(an2));
			//------------------------
			Student an3 = new StudentWithDegree("22456784f", "Gonzalez Perez, Juan", Degree.SOFTWARE, 7.7);
			precond("22456784f", an3.getDni());
			precond("Gonzalez Perez, Juan", an3.getName());
			precond(7.7, an3.getGrade(), 1e-6);
			assertTrue("\n> Error: an1.equals(an3): ", an1.equals(an3));
			//------------------------
			Student an4 = new StudentWithDegree("22456784F", "gonzalez perez, juan", Degree.INFORMATICA, 5.5);
			precond("22456784F", an4.getDni());
			precond("gonzalez perez, juan", an4.getName());
			precond(5.5, an4.getGrade(), 1e-6);
			assertFalse("\n> Error: an1.equals(an4): ", an1.equals(an4));
			//------------------------
			Student an5 = new StudentWithDegree("11111111A", "Gonzalez Perez, Juan", "Software", 5.5);
			precond("11111111A", an5.getDni());
			precond("Gonzalez Perez, Juan", an5.getName());
			precond(5.5, an5.getGrade(), 1e-6);
			assertFalse("\n> Error: an1.equals(an5): ", an1.equals(an5));
		...
		public void alumnoHashCodeTest1() throws Exception {
			...
			int an1HashCode = an1.hashCode();
			//------------------------
			Student an2 = new StudentWithDegree("22456784F", "Gonzalez Perez, Juan", "Software", 7.7);
			precond("22456784F", an2.getDni());
			precond("Gonzalez Perez, Juan", an2.getName());
			precond(7.7, an2.getGrade(), 1e-6);
			assertEquals("\n> Error: an2.hashCode(): ", an1HashCode, an2.hashCode());
			//------------------------
			Student an3 = new StudentWithDegree("22456784f", "Gonzalez Perez, Juan", "Software", 7.7);
			precond("22456784f", an3.getDni());
			precond("Gonzalez Perez, Juan", an3.getName());
			precond(7.7, an3.getGrade(), 1e-6);
			assertEquals("\n> Error: an3.hashCode(): ", an1HashCode, an3.hashCode());
			//------------------------
			Student an4 = new StudentWithDegree("22456784F", "gonzalez perez, juan", "Software", 5.5);
			precond("22456784F", an4.getDni());
			precond("gonzalez perez, juan", an4.getName());
			precond(5.5, an4.getGrade(), 1e-6);
			assertNotEquals("\n> Error: an4.hashCode(): ", an1HashCode, an4.hashCode());
		...
		public void alumnoToStringTest1() {
			...
			precond("Gonzalez Perez, Juan", an1.getName());
			precond(5.5, an1.getGrade(), 1e-6);
			precond(Degree.COMPUTADORES, an1.getDegree());
			assertEquals("\n> Error: an1.toString():",
						 normalize("Gonzalez Perez, Juan (22456784F) COMPUTADORES"),
						 normalize(an1.toString()));
		}
		//------------------------------------------------------------------
	}
	...
	//--JUnitTest-----------------------------------------------------------
	//----------------------------------------------------------------------
	public static class JUnitTestSubjectWithDegree {
		private static final String nmAsg = "Algebra";
		private static final String[] inputData = {
		...
		private static Student[] crearStudents() {
			...
			try {
				alumnos = new Student[]{
					new StudentWithDegree("25653443S", "Garcia Gomez, Juan", "Software", 8.1),
					new StudentWithDegree("23322443K", "Lopez Turo, Manuel", "Informatica", 4.3),
					new StudentWithDegree("24433522M", "Merlo Martinez, Juana", "Computadores", 5.3),
					new StudentWithDegree("42424312G", "Lopez Gama, Luisa", "Software", 7.1),
					new StudentWithDegree("76213433Q", "Gomez Ayuso, Laura", "Salud", 8.3),
					new StudentWithDegree("89234024N", "Navas Perez, Luis", "Informatica", 6.5),
					new StudentWithDegree("92748362F", "Leon Zarate, Maria", "Computadores", 7.5)
				};
			} catch (Exception e) {
				fail("\n> Error: crearStudents: throws unexpected exception");
			}
		...
		private static void precondSubjectWithDegree(SubjectWithDegree asg) {
			precond(inputValues, asg.getStudents());
			precondNorm(inputErrors, asg.getErrors());
		}
		private SubjectWithDegree asg1;
		@BeforeClass
		public static void beforeClass() {
			// Code executed before the first test method
			System.out.println("Start of SubjectWithDegree JUnit Test");
		}
		@AfterClass
		public static void  afterClass() {
			// Code executed after the last test method
			System.out.println("End of SubjectWithDegree JUnit Test");
		}
		@Before
		public void setUp() {
			// Code executed before each test
			asg1 = new SubjectWithDegree(nmAsg, inputData, null);
		}
		@After
		public void tearDown() {
			// Code executed after each test
		...
		@Test(timeout = 1000)
		public void asignaturaCtorTest1() {
			assertArrayEquals("\n> Error: new SubjectWithDegree(): asg1.getStudents():", inputValues, asg1.getStudents());
			assertArrayEqualsNorm("\n> Error: new SubjectWithDegree(): asg1.getErrors():", inputErrors, asg1.getErrors());
			assertEquals("\n> Error: new SubjectWithDegree(): asg1.getAverageCalculation():", null, asg1.getAverageCalculation());
		}
		@Test(timeout = 1000)
		public void asignaturaCtorTest2() {
			precondSubjectWithDegree(asg1);
			ArithmeticMean cm = new ArithmeticMean();
			SubjectWithDegree asg2 = new SubjectWithDegree(nmAsg, inputData, cm);
			assertArrayEquals("\n> Error: new SubjectWithDegree(): asg2.getStudents():", inputValues, asg2.getStudents());
			assertArrayEqualsNorm("\n> Error: new SubjectWithDegree(): asg2.getErrors():", inputErrors, asg2.getErrors());
			assertEquals("\n> Error: new SubjectWithDegree(): asg2.getAverageCalculation():", cm, asg2.getAverageCalculation());
		}
		@Test(timeout = 1000)
		public void asignaturaSetCalcAverageTest1() throws Exception {
			precondSubjectWithDegree(asg1);
		...
		public void asignaturaCalcAverageTest1() throws Exception {
			precondSubjectWithDegree(asg1);
			asg1.setAverageCalculation(new ArithmeticMean());
			assertEquals("\n> Error: asg1.getAverage():", 6.728571, asg1.getAverage(), 1e-6);
		}
		@Test(timeout = 1000)
		public void asignaturaCalcAverageTest2() {
			precondSubjectWithDegree(asg1);
			try {
				String[] datos = { "xxx" };
				Subject asg2 = new SubjectWithDegree(nmAsg, datos, new ArithmeticMean());
				double valor = asg2.getAverage();
				fail("\n> Error: getAverage(): No exception thrown");
			} catch (StudentException e) {
				assertEquals("\n> Error: getAverage(): exception.getMessage():", normalize("No students"), normalize(e.getMessage()));
		...
		@Test(timeout = 1000)
		public void asignaturaGetAverageDegreeTest1() throws Exception {
			precondSubjectWithDegree(asg1);
			asg1.setAverageCalculation(new ArithmeticMean());
			assertEquals("\n> Error: asg1.getAverage(Degree.COMPUTADORES):", 6.4, asg1.getAverage(Degree.COMPUTADORES), 1e-6);
		}
		@Test(timeout = 1000)
		public void asignaturaGetAverageDegreeTest2() throws Exception {
			precondSubjectWithDegree(asg1);
			asg1.setAverageCalculation(new ArithmeticMean());
			assertEquals("\n> Error: asg1.getAverage(Degree.INFORMATICA):", 5.4, asg1.getAverage(Degree.INFORMATICA), 1e-6);
		}
		@Test(timeout = 1000)
		public void asignaturaGetAverageDegreeTest3() throws Exception {
			precondSubjectWithDegree(asg1);
			asg1.setAverageCalculation(new ArithmeticMean());
			assertEquals("\n> Error: asg1.getAverage(Degree.SOFTWARE):", 7.6, asg1.getAverage(Degree.SOFTWARE), 1e-6);
		}
		@Test(timeout = 1000)
		public void asignaturaGetAverageDegreeTest4() throws Exception {
			precondSubjectWithDegree(asg1);
			asg1.setAverageCalculation(new ArithmeticMean());
			assertEquals("\n> Error: asg1.getAverage(Degree.SALUD):", 8.3, asg1.getAverage(Degree.SALUD), 1e-6);
		}
		@Test(timeout = 1000)
		public void asignaturaGetAverageDegreeTest5() {
			precondSubjectWithDegree(asg1);
			try {
				String[] datos = { "xxx" };
				SubjectWithDegree asg2 = new SubjectWithDegree(nmAsg, datos, new ArithmeticMean());
				double valor = asg2.getAverage(Degree.COMPUTADORES);
				fail("\n> Error: getAverage(Degree.COMPUTADORES): No exception thrown");
			} catch (StudentException e) {
				assertEquals("\n> Error: getAverage(Degree.COMPUTADORES): exception.getMessage():", normalize("No students"), normalize(e.getMessage()));
			} catch (Exception e) {
				fail("\n> Error: getAverage(Degree.COMPUTADORES): the exception thrown is not StudentException");
			}
		}
		@Test(timeout = 1000)
		public void asignaturaGetCalificacionTest1() throws Exception {
			...
			assertEquals("\n> Error: asg1.getGrade(Merlo Martinez, Juana):", 5.3, asg1.getGrade(inputValues[2]), 1e-6);
			assertEquals("\n> Error: asg1.getGrade(Lopez Gama, Luisa):", 7.1, asg1.getGrade(inputValues[3]), 1e-6);
			assertEquals("\n> Error: asg1.getGrade(Gomez Ayuso, Laura):", 8.3, asg1.getGrade(inputValues[4]), 1e-6);
			assertEquals("\n> Error: asg1.getGrade(Navas Perez, Luis):", 6.5, asg1.getGrade(inputValues[5]), 1e-6);
			assertEquals("\n> Error: asg1.getGrade(Leon Zarate, Maria):", 7.5, asg1.getGrade(inputValues[6]), 1e-6);
		}
		@Test(timeout = 1000)
		public void asignaturaGetCalificacionTest2() {
			precondSubjectWithDegree(asg1);
			try {
				Student an2 = new StudentWithDegree("34242432J", "Fernandez Vara, Pedro", Degree.SALUD);
				double valor = asg1.getGrade(an2);
				fail("\n> Error: asg1.getGrade(Fernandez Vara, Pedro): No exception thrown");
			} catch (StudentException e) {
				assertEquals("\n> Error: asg1.getGrade(Fernandez Vara, Pedro): exception.getMessage():", normalize("The student Fernandez Vara, Pedro (34242432J) SALUD has not been found"), normalize(e.getMessage()));
			} catch (Exception e) {
				fail("\n> Error: asg1.getGrade(Fernandez Vara, Pedro): the exception thrown is not StudentException");
			}
		}
		...
		public void asignaturaToStringTest1() {
			precondSubjectWithDegree(asg1);
			assertEquals("\n> Error: asg1.toString():",
						 normalize("Algebra : { [ Merlo Martinez , Juana ( 24433522 M ) COMPUTADORES , Leon Zarate , Maria ( 92748362 F ) COMPUTADORES , Lopez Turo , Manuel ( 23322443 K ) INFORMATICA , Navas Perez , Luis ( 89234024 N ) INFORMATICA , Garcia Gomez , Juan ( 25653443 S ) SOFTWARE , Lopez Gama , Luisa ( 42424312 G ) SOFTWARE , Gomez Ayuso , Laura ( 76213433 Q ) SALUD ] , [ ERROR . Negative grade : 53553421 D ; Santana Medina , Petra ; Software ; -7.1 , ERROR . Missing data : 55343442 L , Godoy Molina , Marina ; Informatica ; 6.3 , ERROR . Non numerical grade : 34242432 J ; Vara Riera , Pedro ; Computadores ; 2 . k , ERROR . Wrong degree : 21658324 F ; Jimenez Ayo , Pepe ; Medicina ; 8.3 ] }"),
						 normalize(asg1.toString()));
		}
		//------------------------------------------------------------------
	}
	...
	@Suite.SuiteClasses({ JUnitTestStudentException.class ,
				...
				JUnitTestDegree.class ,
				JUnitTestStudentWithDegree.class ,
				JUnitTestSubjectWithDegree.class
				})
