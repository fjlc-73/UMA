...
public class TestRunnerPr41Ej1 {
	...
	//--JUnitTest-----------------------------------------------------------
	//----------------------------------------------------------------------
	public static class JUnitTestMainStudent {
		@BeforeClass
		public static void beforeClass() {
			// Code executed before the first test method
		...
		public void pruebaStudentMainTest1() {
			...
			// elimino StackTrace de la salida, ya que podria variar segun entorno y version
			int idx = salida.indexOf("at ");
			if (idx >= 0) {
				salida = salida.substring(0, idx);
			}
			assertEquals("\n> Error: MainStudent.main():",
						 normalize("DNI : 22456784 F , Name : Gonzalez Perez , Juan , Grade : 5.5 DNI : 33456777 S , Name : Gonzalez Perez , Juan , Grade : 3.4 The students Gonzalez Perez , Juan ( 22456784 F ) and Gonzalez Perez , Juan ( 33456777 S ) are not equal prGrading . StudentException : Negative grade"),
						 normalize(salida));
		}
		//------------------------------------------------------------------
	}
	...
	//--JUnitTest-----------------------------------------------------------
	//----------------------------------------------------------------------
	public static class JUnitTestMainSubject {
		@BeforeClass
		public static void beforeClass() {
			// Code executed before the first test method
		...
		public void pruebaSubjectMainTest1() {
			...
			assertEquals("\n> Error: MainSubject.main():",
						 normalize("Average 7.20 DNIs : 12455666 F , 33678999 D , 23555875 G Grade of Lopez Perez , Pedro ( 12455666 F ) : 6.7 The student Lopez Lopez , Pedro ( 12455666 F ) has not been found"),
						 normalize(salida));
		} 
		//------------------------------------------------------------------
	}
