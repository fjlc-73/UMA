...
public class BookStoreTest {
	...
	public static void main(String[] args) {
		...
		list.addBook("Philip K. Dick", "¿Sueñan los androides con ovejas electricas?",  3.50);
		...
		list.addBook("Isaac Asimov","La Fundacion",  7.30);
	    ...
	    System.out.println("FinalPrice(\"Philip K. Dick\", \"¿Sueñan los androides con ovejas eléctricas?\"):" + list.getFinalPrice("Philip K. Dick", "¿Sueñan los androides con ovejas electricas?"));
	    ...
	    System.out.println("FinalPrice(\"Isaac Asimov\", \"La Fundación\"):" + list.getFinalPrice("Isaac Asimov", "La Fundacion"));
